...
def client():
    ...
    assert branch_london.get_opening() == "9:00"

    branch_london.set_opening("8:00")
    assert branch_london.get_opening() == "8:00"
    ...
    assert branch_sheffield.get_opening() == "9:00"
    ...
    assert customer_alice.get_phone() == "NO PHONE NUMBER"
    ...
    payroll = Payroll()
    payroll.set_staff_category_pay_schedule(pay_date="31", staff_category="Manager")
    assert payroll.get_staff_category_pay_schedule("Manager") == "31"
